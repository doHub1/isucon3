...
module RbConfig
  ...
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/home/isucon/.local/ruby-2.3")
  ...
  CONFIG["configure_args"] = " '--prefix=/home/isucon/.local/ruby-2.3' 'LDFLAGS=-L/home/isucon/.local/ruby-2.3/lib ' 'CPPFLAGS=-I/home/isucon/.local/ruby-2.3/include '"
  ...
  CONFIG["RUBY_EXEC_PREFIX"] = "/home/isucon/.local/ruby-2.3"
  ...
  CONFIG["OBJEXT"] = "o"
  CONFIG["CPPFLAGS"] = "-I/home/isucon/.local/ruby-2.3/include  $(DEFS) $(cppflags)"
  CONFIG["LDFLAGS"] = "-L. -L/home/isucon/.local/ruby-2.3/lib  -fstack-protector -rdynamic -Wl,-export-dynamic"
